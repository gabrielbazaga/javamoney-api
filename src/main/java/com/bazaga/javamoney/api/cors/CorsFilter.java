...
public class CorsFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		response.setHeader("Access-Control-Allow-Origin", javamoneyApiProperty.getOriginPermitida());
		...
		if ("OPTIONS".equals(request.getMethod()) && javamoneyApiProperty.getOriginPermitida().equals(request.getHeader("Origin"))){
